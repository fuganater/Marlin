...
#define COLOR_ORANGEZ           0xFDE0   //0xFE20   // 0xFFE0   //0XFD80   //0xFD20   //0xFC60  //#F06C00 0xFB40  //#ff6a00 
#define COLOR_BACKGROUND        0x2124   //262626  0x20AC  // #1E156E
#define COLOR_SELECTION_BG      COLOR_ORANGEZ   //0x9930  // #992380
...
#define COLOR_COLD              COLOR_ORANGEZ   //COLOR_WHITE
#define COLOR_HOTEND            COLOR_REDZ
#define COLOR_HEATED_BED        COLOR_REDZ
#define COLOR_CHAMBER           COLOR_DARK_ORANGE
#define COLOR_FAN               COLOR_ORANGEZ   //COLOR_WHITE

#define COLOR_AXIS_HOMED        COLOR_WHITE
#define COLOR_AXIS_NOT_HOMED    COLOR_ORANGEZ   //COLOR_YELLOW

#define COLOR_RATE_100          0xA7E0   //0xA780   //0xA700   //0x9E45    //COLOR_WHITE    //COLOR_VIVID_GREEN
#define COLOR_RATE_ALTERED      COLOR_ORANGEZ   //COLOR_YELLOW

#define COLOR_PRINT_TIME        COLOR_WHITE             //COLOR_AQUA

#define COLOR_PROGRESS_FRAME    COLOR_WHITE
#define COLOR_PROGRESS_BAR      COLOR_ORANGEZ     //COLOR_BLUE
#define COLOR_PROGRESS_BG       COLOR_BLACK

#define COLOR_STATUS_MESSAGE     COLOR_ORANGEZ           //COLOR_YELLOW

#define COLOR_CONTROL_ENABLED    COLOR_ORANGEZ //COLOR_WHITE
